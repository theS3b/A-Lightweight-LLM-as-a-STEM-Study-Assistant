...
def get_mnlp_randomsampling(tokenizer, train_size, val_size, seed, seqlen, test_only):
    print("get_mnlp_randomsampling")

    data = load_dataset("TheS3b/unified-dataset-filtered-430K", split="train")
    print("Filtering...")
...
def get_loaders(
    ...
    elif 'get_mnlp_randomsampling' in name:
        return get_mnlp_randomsampling(tokenizer,train_size,val_size,seed,seqlen,test_only)
    else:
