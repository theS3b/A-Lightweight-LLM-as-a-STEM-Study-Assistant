...
--output_dir /scratch/izar/delsad/mnlp_cache/EfficientQAT/block_ap_log/Qwen3-w3g64 \
--wbits 2 \
...
--save_quant_dir /scratch/izar/delsad/mnlp_cache/EfficientQAT/block_ap_models/Qwen3-w3g64