# MCQA model training code

## Running the bash script
To run the bash script for training the MCQA model, you need to have Python 3.12.8 installed on your system. The script will automatically create a virtual environment and install all the necessary dependencies.

## Preprocessing the data
The directory `preprocessing` contains the code for preprocessing the data. More specifically:
